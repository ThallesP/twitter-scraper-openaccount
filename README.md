...
[![Go Reference](https://pkg.go.dev/badge/github.com/ThallesP/twitter-scraper-openaccount.svg)](https://pkg.go.dev/github.com/ThallesP/twitter-scraper-openaccount)
...
```shell
go get -u github.com/ThallesP/twitter-scraper-openaccount
```
